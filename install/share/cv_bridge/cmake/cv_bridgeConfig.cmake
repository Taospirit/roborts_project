...
if("FALSE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/a/roborts_project/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/a/roborts_project/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/a/roborts_project/install)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/a/roborts_project/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/a/roborts_project/install/lib;/home/a/roborts_project/install/lib;/opt/ros/melodic/lib)
