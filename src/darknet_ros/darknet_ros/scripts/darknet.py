...
lib = CDLL("/home/nvidia/Documents/darknet/libdarknet.so", RTLD_GLOBAL)
...
if __name__ == "__main__":
    net = load_net("cfg/yolov3-voc.cfg", "backup/yolov3-voc_final.weights", 0)
    meta = load_meta("cfg/voc.data")
    r = detect(net, meta, "data/image4000.jpg")
    print r
