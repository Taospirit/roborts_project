...
namespace roborts_localization {
    ...
    bool LocalizationNode::Init() {
        ...
        localization_config.GetParam(&nh_private);
        ...
        init_pose_topic_ = std::move(localization_config.init_pose_topic_name);
        ...
        initial_pose_sub_ = nh_.subscribe(init_pose_topic_, 2, &LocalizationNode::InitialPoseCallback, this);
