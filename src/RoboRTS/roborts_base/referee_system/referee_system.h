 ...
 */
    ...
    private:
        ...
        void TeammateMsgToSendCallback(const roborts_msgs::TeammateMsg::ConstPtr dataToSend);

        /** Teammate data **/
        void TeammateRevCallback(const std::shared_ptr<roborts_sdk::cmd_rev_student_data> robot_data);
        ...
        std::shared_ptr<roborts_sdk::Publisher<roborts_sdk::cmd_student_data>> teammate_pub_;

        //! ros node handler
        ros::NodeHandle ros_nh_;
        //! ros subscriber for projectile supply
        ros::Subscriber ros_sub_projectile_supply_;
        ros::Subscriber ros_sub_teammate_msg_;
        ...
        ros::Publisher ros_robot_rev_teammate_pub_;

        uint8_t robot_id_ = 0xFF;
        uint16_t robot_remain_hp = 0xFFFF;
    };
}
