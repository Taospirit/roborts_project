 ...
 */
    ...
    public:
         ...
         */
        Gimbal(std::shared_ptr<roborts_sdk::Handle> handle, std::string robot_base_frame_name,
    ...
    private:
        ...
        void FricSpeedCallback(const roborts_msgs::FricSpeed::ConstPtr &msg);

        void GimbalProjectileCallback(const roborts_msgs::ProjectileInfo::ConstPtr &msg);
        ...
        //! ros subscriber for projectile message
        ros::Subscriber ros_sub_projectile_src_;
        //! ros subscriber for change fric speed
        ros::Subscriber ros_sub_set_fric_speed_;
