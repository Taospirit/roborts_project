...
int main(int argc, char **argv) {
    ...
    roborts_base::Chassis chassis(handle, config.odom_frame_name, config.robot_base_frame_name, config.speed);
    roborts_base::Gimbal gimbal(handle, config.robot_base_frame_name, config.gimbal_frame_name);
