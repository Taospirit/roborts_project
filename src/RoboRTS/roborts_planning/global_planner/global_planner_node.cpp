...
namespace roborts_global_planner {
    ...
    GlobalPlannerNode::GlobalPlannerNode(std::string global_frame_name,
...
int main(int argc, char **argv) {
    ...
    nh.param<std::string>("global_frame_name", global_frame_name, "map");
    nh.param<std::string>("robot_base_frame_name", robot_base_frame_name, "base_link");
    nh.param<std::string>("sensor_frame_name", sensor_frame_name, "base_laser_link");

    roborts_global_planner::GlobalPlannerNode global_planner(global_frame_name, robot_base_frame_name,
                                                             sensor_frame_name);
    ros::spin();
    return 0;
}
