...
namespace roborts_local_planner {
    ...
    LocalPlannerNode::LocalPlannerNode(std::string global_frame_name,
                                       std::string robot_base_frame_name,
                                       std::string sensor_frame_name) :
            global_frame_(global_frame_name),
            robot_base_frame_(robot_base_frame_name),
            sensor_frame_(sensor_frame_name),
    ...
    roborts_common::ErrorInfo LocalPlannerNode::Init() {
        ...
        ros::NodeHandle nh_;
        vel_pub_ = nh_.advertise<roborts_msgs::TwistAccel>("cmd_vel_acc", 5);
...
int main(int argc, char **argv) {
    ...
    nh_.param<std::string>("robot_base_frame_name", robot_base_frame_name, "base_link");
    nh_.param<std::string>("sensor_frame_name", sensor_frame_name, "base_laser_link");
    roborts_local_planner::LocalPlannerNode local_planner(global_frame_name, robot_base_frame_name, sensor_frame_name);
