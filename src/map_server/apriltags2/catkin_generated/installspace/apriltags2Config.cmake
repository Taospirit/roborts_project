...
if("FALSE" STREQUAL "TRUE")
  set(apriltags2_SOURCE_PREFIX /home/nvidia/hitsz_icra_2019/src/RoboRTS/roborts_tag/apriltags2)
  set(apriltags2_DEVEL_PREFIX /home/nvidia/hitsz_icra_2019/devel_isolated/apriltags2)
  ...
  set(apriltags2_INSTALL_PREFIX /home/nvidia/hitsz_icra_2019/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/hitsz_icra_2019/install_isolated/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/hitsz_icra_2019/install_isolated/lib;/home/nvidia/hitsz_icra_2019/devel/lib;/opt/ros/kinetic/lib)
